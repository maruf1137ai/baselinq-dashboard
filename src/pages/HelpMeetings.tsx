...
export default function HelpMeetings() {
  ...
  // deep link out of /meetings, anywhere — rather than always dumping them on
  // /meetings. history.state.idx is React Router's history index: 0 (or
  // undefined) means this page is the first entry, so there is nothing to
  // pop and we fall back to /meetings.
  const goBack = () => {
