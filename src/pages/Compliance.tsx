...
const complianceItems = [
  ...
  },
  {
    ...
    evidence: { current: 3, required: 3 },
    blocksPayment: false,
    notes: "Permit renewed and valid through December 2026.",
    lastUpdate: "3 days ago by Project Manager",
  },
  {
    id: "COMP-003",
    ...
    status: "compliant",
    risk: "low",
    evidence: { current: 2, required: 2 },
    blocksPayment: false,
    notes: "All 15 workers completed induction. Certificate issued.",
  },
  {
    id: "COMP-004",
    ...
    status: "compliant",
    risk: "low",
    evidence: { current: 4, required: 4 },
    blocksPayment: false,
    notes: "Engineer sign-off received. All load test results on file.",
  },
  {
    id: "COMP-005",
