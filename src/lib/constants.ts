 ...
 * h-12, recessed (muted) fill. Used inside inputCls() helper in those pages.
 */
export const INPUT_BASE =
  "w-full h-12 px-4 rounded-[10px] text-sm text-foreground outline-none transition-all bg-muted border border-input focus:border-primary focus:ring-2 focus:ring-primary/10";
...
export const SELECT_BASE =
  "w-full h-12 px-4 pr-9 rounded-[10px] text-sm text-foreground outline-none bg-muted border border-input appearance-none cursor-pointer focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all";

/**
 * Textarea variant — same palette, taller radius to match design.
 */
export const TEXTAREA_BASE =
  "w-full px-4 py-4 rounded-[10px] text-sm text-foreground outline-none transition-all resize-none bg-muted border border-input focus:border-primary focus:ring-2 focus:ring-primary/10 leading-relaxed";
