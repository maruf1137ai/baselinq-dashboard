      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-3 mt-6">
        <div className="col-span-2">
          <Card className="">
            ...
            <CardContent className="space-y-3 bg-white p-[7px] mx-2 mb-2 rounded-md">
              <div className="flex flex-col h-full">
                <div className="p-6 space-y-6 overflow-y-auto">
                  {/* VO Summary Section */}
                  <section>
                    <SummaryRow label="Original Contract Value" value="R 15.00 M" valueColor="text-foreground" />
                  ...
                  <section>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-sm text-muted-foreground">Contingency Remaining</h3>
                      <span className="text-sm font-medium text-foreground">R 509 K / R 750 K</span>
                    </div>
                ...
                <div className="p-6 space-y-6 overflow-y-auto">
                  <div className="nav flex items-center gap-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-base text-muted-foreground">Forecast</span>
                    </div>
                  </div>
            ...
            <CardContent className="space-y-3 bg-white p-[7px] mx-2 mb-2 rounded-md">
              <div className="flex flex-col h-full">
                <div className="p-6 space-y-6 overflow-y-auto">
                  {/* VO Summary Section */}
                  <section>
                    <SummaryRow label="Remaining to Certify" value="R 13.1 M" valueColor="text-foreground" />
                    <SummaryRow label="Projected Fees" value="R 131 K" valueColor="text-foreground" />
                  </section>

                  <footer className="">
                    <div className="bg-sidebar rounded-lg p-3.5 text-sm text-muted-foreground">
                      Projected completion: <span className="text-foreground">20 months</span> at <br />
          ...
          <CardContent className="space-y-3 bg-white p-[7px] mx-2 mb-2 rounded-md">
            <div className="flex flex-col h-full">
              <div className="p-6 space-y-6 overflow-y-auto">
                {/* VO Summary Section */}
                <section>
                  <SummaryRow label="Remaining to certify" value="R 12,930,000" valueColor="text-foreground" />
                  <SummaryRow label="Pipeline VOs" value="R 154,000" valueColor="text-foreground" />
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-base text-foreground">Total Value</span>
                    <span className="text-base text-foreground">R 130,840</span>
                  </div>
                  {/* <div className="border-t border-gray-200 my-3"></div> */}
                </section>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className="text-base text-muted-foreground">Available</span>
                      </div>
                      <span className="text-base text-foreground">R 226,011</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        <span className="w-3 h-3 bg-[#F59E0B] rounded-full mr-3"></span>
                        <span className="text-base text-muted-foreground">Pending</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className="text-base text-muted-foreground">Committed</span>
                      </div>
                      <span className="text-sm font-medium text-gray-900">R 0</span>
                    </div>
                    <div className="flex justify-between items-center">
