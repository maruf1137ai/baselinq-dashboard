...
const SectionHeader: React.FC<{ children: React.ReactNode }> = ({
  ...
  <h3 className="text-sm text-[#0E1C2E] mb-3">{children}</h3>
);
  ...
  return (
    ...
    >
      ...
      <input
        ...
        disabled={disabled}
        className="flex-1 px-2.5 py-1.5 text-sm text-[#0E1C2E] focus:outline-none bg-transparent disabled:bg-gray-50 disabled:text-[#6B7280] w-full"
        placeholder="0"
      />
    </div>
  );
      ...
      >
        ...
        <header className="flex justify-between items-center px-6 py-4 border-b border-gray-200 shrink-0">
          <div>
            <h2
              id="create-pc-title"
              className="text-base text-[#0E1C2E]"
            >
          ...
          <div className="p-6 space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={pcNumber}
                    readOnly
                    className="w-full px-3 py-2 text-sm text-[#6B7280] bg-gray-50 border border-gray-200 rounded-md cursor-not-allowed"
                  />
                </div>
                {/* Valuation Period */}
                <div>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button className="w-full flex items-center justify-between px-3 py-2 text-sm text-[#0E1C2E] border border-gray-200 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[#8081F6]">
                        <span>
                          {valuationPeriod
            ...
            <section>
              <div className="flex justify-between items-center mb-3">
                ...
                <button
                  onClick={addWorkItem}
                  className="flex items-center gap-1 text-xs text-[#8081F6] hover:text-[#6366F1] transition-colors"
                >
                ...
                <table className="w-full text-sm min-w-[780px]">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="px-3 py-2.5 text-left text-xs font-normal text-[#6B7280] uppercase tracking-wider">
                        Description
                      </th>
                      <th className="px-3 py-2.5 text-right text-xs font-normal text-[#6B7280] uppercase tracking-wider whitespace-nowrap">
                        Contract Value
                      </th>
                      <th className="px-3 py-2.5 text-right text-xs font-normal text-[#6B7280] uppercase tracking-wider whitespace-nowrap">
                        Prev. Certified
                      ...
                      <th className="px-3 py-2.5 text-right text-xs font-normal text-[#6B7280] uppercase tracking-wider">
                        Cumulative
                      </th>
                      <th className="px-3 py-2.5 text-right text-xs font-normal text-[#6B7280] uppercase tracking-wider">
                        % Complete
                        ...
                        <tr key={item.id} className="hover:bg-gray-50/60">
                          <td className="px-3 py-2">
                            <input
                              ...
                              className="w-full text-sm text-[#0E1C2E] focus:outline-none bg-transparent border-b border-transparent focus:border-[#8081F6] py-0.5 min-w-[130px]"
                          ...
                          <td className="px-3 py-2 text-right text-sm text-[#6B7280] whitespace-nowrap">
                          ...
                          <td className="px-3 py-2 text-right text-sm text-[#0E1C2E] whitespace-nowrap">
                            {fmt(cumulative)}
                          </td>
                  ...
                  <tfoot>
                    <tr className="bg-gray-50 border-t-2 border-gray-200">
                      <td className="px-3 py-2.5 text-xs text-[#0E1C2E]">
                        Totals
                      </td>
                      <td className="px-3 py-2.5 text-right text-xs text-[#0E1C2E]">
                  ...
                  <tbody className="divide-y divide-gray-100 bg-white">
                    {voItems.map((vo) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-3 text-[#0E1C2E] text-sm max-w-[220px] truncate">
                          {vo.description}
                        </td>
                        <td className="px-3 py-3 text-right text-sm text-[#0E1C2E]">
                          {fmt(vo.approvedValue)}
                        </td>
                        <td className="px-3 py-3 text-right text-sm text-[#6B7280]">
            ...
            <section>
              ...
              <div className="bg-[#F9FAFB] rounded-lg border border-gray-200 px-5 py-4">
                {/* Build-up */}
                <SummaryLine
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                <div className="flex justify-between items-center border border-gray-200 rounded-lg px-4 py-3">
                  <span className="text-xs text-[#6B7280]">Claim</span>
                  <span className="text-sm text-[#0E1C2E]">{fmtCard(calc.netValuationThisPeriod)}</span>
                </div>
                <div className="flex justify-between items-center border border-gray-200 rounded-lg px-4 py-3">
                  <span className="text-xs text-[#6B7280]">Retention @ 5%</span>
                  <span className="text-sm text-[#0E1C2E]">{fmtCard(calc.retention)}</span>
                </div>
                <div className="flex justify-between items-center border border-gray-200 rounded-lg px-4 py-3 bg-[#f8f7ff]">
                  <span className="text-xs text-[#6B7280]">Net (Amount Due)</span>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2.5 text-sm text-[#0E1C2E] border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-[#8081F6] focus:border-[#8081F6] resize-none placeholder:text-gray-400"
                      ...
                      {attachments.map((file, i) => (
                        ...
                        >
                          <div className="flex items-center gap-2 min-w-0">
                            <Paperclip className="w-3.5 h-3.5 text-[#6B7280] shrink-0" />
                            <span className="text-sm text-[#0E1C2E] truncate">
                              {file.name}
                            </span>
        ...
        <footer className="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-white shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2 text-sm text-[#6B7280] border border-gray-200 rounded-md hover:bg-gray-50 transition-colors"
            >
              Cancel
            </button>
            <button
