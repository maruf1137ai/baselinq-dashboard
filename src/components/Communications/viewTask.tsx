      ...
      <DialogContent className="fixed right-0 top-0 !left-auto !translate-x-0 !translate-y-0 h-screen w-[500px] rounded-none border-0 bg-white text-foreground shadow-xl data-[state=open]:animate-in data-[state=open]:slide-in-from-right data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right">
        ...
        <div className="">
          <div className="w-full overflow-auto">
            <div className="p-0">
              <h1 className="text-lg text-foreground">{task.title}</h1>
            ...
            <div className="pt-8">
              {activeTab === "Overview" && (
                <div className="">
                  <section>
                    <h2 className="text-sm text-foreground">Task Summary</h2>
                    <p className="mt-3.5 text-muted-foreground">{task.summary}</p>
                  </section>
              ...
              {activeTab === "Comments" && (
                <div className="flex flex-col gap-5">
                  <div className="comment flex gap-3">
                    ...
                    <div>
                      <div className="name flex items-center gap-2 text-foreground text-sm">
                        David Zhang
                        <span className="text-muted-foreground/50 text-xs">
                          2 hours ago
                        </span>
                      </div>
                      <div className="desc mt-1.5 text-muted-foreground text-sm">
              ...
              {activeTab === "Attachments" && (
                <div className="grid grid-cols-2 gap-5">
                  <button className="item border border-border p-4 rounded-xl flex flex-col justify-start items-start">
                    <div className="icon">
                    ...
                    <p className="text-xs mt-1 text-muted-foreground/50">2.4 MB</p>
                  </button>
                  <button className="item border border-border p-4 rounded-xl flex flex-col justify-start items-start">
                    <div className="icon">
                      <Paperclip className="h-4 w-4" />
                ...
                <div className="flex flex-col">
                  <div className="item flex gap-3 border-b border-border py-3">
                    ...
                    <div className="">
                      ...
                      <div className="text mt-1 text-muted-foreground text-xs flex gap-2">
                        System
                        <span className="text-muted-foreground/50">· 2 hours ago</span>
                      </div>
                    </div>
                  </div>
                  <div className="item flex gap-3 border-b border-border py-3">
