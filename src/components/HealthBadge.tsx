      ...
      <Tooltip>
        ...
        <TooltipContent side="left" className="p-0 border-0 shadow-lg bg-transparent">
          <div className="bg-card border border-border rounded-xl shadow-md px-4 py-3 min-w-[200px]">
            <p className="text-xs font-medium text-foreground mb-2.5">Health Breakdown</p>

            {/* Schedule row */}
            <div className="flex items-start gap-2 mb-2">
              <span className={`w-1.5 h-1.5 rounded-full shrink-0 mt-1 ${signalDot[schedule.status]}`} />
              <div>
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider leading-none mb-0.5">Schedule</p>
                <p className="text-xs text-foreground">{scheduleText}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider leading-none mb-0.5">Budget</p>
                <p className="text-xs text-foreground">{budgetText}</p>
              </div>
            </div>
          </div>
        </TooltipContent>
