...
const Calander2 = () => {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 1.5V4.5M6 1.5V4.5" stroke="#6B6B6B" strokeWidth="1.125" strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      />
      <path d="M2.25 7.5H15.75" stroke="#6B6B6B" strokeWidth="1.125" strokeLinecap="round" strokeLinejoin="round" />
      <path
