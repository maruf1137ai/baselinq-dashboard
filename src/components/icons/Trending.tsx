  ...
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M5.25 3H6" stroke="currentColor" strokeWidth="1.125" strokeLinecap="round" />
      <path d="M5.25 5.25H8.25" stroke="currentColor" strokeWidth="1.125" strokeLinecap="round" />
      <path
