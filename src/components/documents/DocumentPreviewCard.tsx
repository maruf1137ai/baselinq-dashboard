...
export const DocumentPreviewCard: React.FC<DocumentPreviewCardProps> = ({ doc, onPreview }) => {
  ...
  // Prefer stream URL (inline-friendly) over download URL (may have Content-Disposition: attachment)
  const url =
    ...
    '';
  const fileSize =
    (doc.fileSize as number | undefined) ?? (doc.file_size as number | undefined);
