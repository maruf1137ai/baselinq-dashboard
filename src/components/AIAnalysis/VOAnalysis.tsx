          ...
          <div className="p-6 bg-white border border-border rounded-[14px]">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-sidebar rounded-lg">
                  <p className="text-xs font-medium text-[#6B7280] uppercase mb-2">Rate Analysis</p>
                ...
                {data.valuation_assessment.new_rates_permitted && (
                  <div className="p-4 bg-indigo-50 border border-indigo-100 rounded-lg">
                    ...
                    {data.valuation_assessment.new_rates_permitted.clause_reference && (
                      <p className="text-[10px] text-indigo-500">Ref: {data.valuation_assessment.new_rates_permitted.clause_reference}</p>
                    )}
        ...
        <div className={sectionClass(visibleSections, 4)}>
          <div className="p-6 bg-white border border-border rounded-[14px]">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 bg-sidebar rounded-lg">
                <p className="text-xs font-medium text-[#6B7280] uppercase mb-1">Critical Path</p>
              ...
              <div className="p-4 bg-sidebar rounded-lg">
                <p className="text-xs font-medium text-[#6B7280] uppercase mb-1">Notice Compliance</p>
            ...
            {data.time_impact.eot_entitlement && (
              <div className="mt-4 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                ...
                {data.time_impact.eot_entitlement.clause_reference && (
                  <p className="text-[10px] text-blue-500 mt-2">Ref: {data.time_impact.eot_entitlement.clause_reference}</p>
                )}
              </div>
            )}
          </div>
